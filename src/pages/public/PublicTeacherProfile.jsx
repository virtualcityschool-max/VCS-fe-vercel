const PublicTeacherProfile = () => {
  return (
    <section
      ...
      className="min-h-screen bg-slate-900 text-white font-inter"
    >
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center relative z-10">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="flex flex-col lg:flex-row lg:items-center gap-4 mb-2">
                <h1 className="text-4xl font-black font-poppins tracking-tight">
                  Dr. Samuel Okoro
                </h1>
              ...
              <p className="text-indigo-400 font-bold text-lg mb-6">
                Senior Physics Professor & STEM Architect
              </p>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 mb-8">
                {[
                  ...
                  <span
                    key={tag}
                    className="bg-slate-900/60 text-slate-400 px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest border border-slate-700"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="lg:col-span-2">
            <div className="bg-slate-800 p-10 rounded-[3rem] border border-slate-700/50 shadow-xl h-full flex flex-col">
              ...
              <div className="text-slate-400 leading-relaxed text-lg mb-10 flex-1 space-y-6">
                <p>
                  Dr. Samuel Okoro is a world-renowned educator specializing in
                  theoretical physics. With a Ph.D. from Cambridge, he brings a
                  unique depth to{" "}
                ...
                <p>
                  He has mentored over{" "}
                  <span className="text-indigo-400 font-bold">
                    1,200 students
                  </span>{" "}
                  across the globe, maintaining one of the highest satisfaction
                  ratings in the VirtualCity ecosystem.
                </p>
              </div>
              ...
              <div className="bg-slate-950/50 p-8 rounded-4xl border-l-4 border-indigo-600 italic shadow-inner">
                <p className="text-slate-300 font-medium leading-relaxed text-lg">
                  "At VirtualCitySchool, we learn to visualize the fabric of
                  reality. My goal is to transform every learner into a critical
                  thinker."
                </p>
                <p className="mt-4 text-[10px] text-indigo-400 font-black uppercase tracking-widest not-italic">
            ...
            <div className="bg-slate-800 p-10 rounded-[3rem] border border-slate-700/50 shadow-xl">
              ...
              <ul className="space-y-8">
                {[
                  {
                    icon: "fa-award",
                    title: "Top 1% STEM Mentor",
                    subtitle: "VirtualCity Elite",
                  },
                  {
                    icon: "fa-microscope",
                    title: "Senior Research Fellow",
                    subtitle: "Global Physics League",
                  },
                ].map((cert, idx) => (
                  <li key={idx} className="flex items-start gap-5 group">
                    <div className="w-12 h-12 rounded-2xl bg-indigo-600/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition shadow-lg">
                      <i
                        className={`fas ${cert.icon} text-indigo-400 text-xl`}
                      ></i>
                    </div>
                    <div>
                      <p className="font-bold text-slate-200 text-sm leading-tight mb-1">
                        {cert.title}
                      </p>
                      <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest">
                        {cert.subtitle}
