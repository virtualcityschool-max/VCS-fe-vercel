        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8">
                ...
                <div className="bg-slate-800 p-8 rounded-[2.5rem] border border-slate-700 shadow-lg flex flex-col h-full group hover:border-indigo-500/30 transition">
                  <div className="flex justify-between items-start mb-6">
                    <img
                      ...
                      className="w-20 h-20 rounded-3xl border-2 border-indigo-500 shadow-md group-hover:scale-105 transition"
                      alt="Sarah"
                    />
                    <span className="bg-emerald-500/20 text-emerald-400 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider border border-emerald-500/20">
                  ...
                  <div className="pt-6 border-t border-slate-700 flex justify-between items-center mt-auto">
                    ...
                    <button className="text-indigo-400 hover:text-white transition">
                ...
                <div className="bg-slate-800 p-8 rounded-[2.5rem] border-2 border-red-500/20 shadow-2xl flex flex-col h-full group">
                  <div className="flex justify-between items-start mb-6">
                    <img
                      ...
                      className="w-20 h-20 rounded-3xl border-2 border-red-500 shadow-md group-hover:scale-105 transition"
                      alt="Ahmed"
                    />
                    <span className="bg-red-500/20 text-red-500 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider border border-red-500/20 animate-pulse">
                      Risk Alert
                    </span>
                  </div>
                  ...
                  <div className="pt-6 border-t border-slate-700 flex justify-between items-center mt-auto">
                    ...
                    <button className="bg-red-600 hover:bg-red-500 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition">
                      Review Task
                    </button>
                  </div>
                </div>
          ...
          <div className="lg:col-span-3 space-y-8">
            <section className="bg-slate-800/50 backdrop-blur-md p-8 rounded-[3rem] border border-slate-700 shadow-xl">
              <h3 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 mb-8">
                VirtualCity Updates
              </h3>
              <ul className="space-y-6">
                {[
                  ...
                  <li
                    key={i}
                    className="group cursor-pointer border-b border-slate-700/50 pb-4 last:border-0 last:pb-0"
                  >
                    <p className="text-sm font-bold text-slate-200 group-hover:text-indigo-400 transition mb-1">
                      {news.t}
                    </p>
            ...
            <section className="bg-slate-800/50 backdrop-blur-md p-8 rounded-[3rem] border border-slate-700 shadow-xl">
              ...
              <div className="relative pl-6 space-y-10">
                ...
                {[
                  {
                    m: "Sarah: Physics Report Graded",
                    t: "2h ago",
                    b: "bg-indigo-500",
                  },
                  {
                    m: "Ahmed: New grade posted",
                    t: "5h ago",
                    b: "bg-slate-500",
                  },
                  {
                    m: "Winter Lab Fees Invoiced",
                    t: "Yesterday",
                    b: "bg-slate-700",
                  },
                ].map((act, i) => (
                  <div key={i} className="relative">
                    <div
                      className={`absolute -left-[23px] top-1 w-4 h-4 rounded-full ${act.b} border-4 border-slate-800 shadow-sm`}
                    ></div>
