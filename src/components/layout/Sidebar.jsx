...
const NAV_CONFIG = {
  admin: [
    ...
    { id: "sessions",    label: "Sessions",     icon: "fas fa-chalkboard",    to: "/admin/sessions" },
    ...
    { id: "training",  label: "Training Centre",  icon: "fas fa-graduation-cap", to: "/admin/training" },
  ],
  teacher: [
    ...
    { label: "My Training",       to: "/teacher/training",        icon: "fas fa-graduation-cap" },
